...
module TestFGUI.BlueSkin {
	...
	export class UI_ScrollBarH extends fairygui.GScrollBar {
		...
		public static URL:string = "ui://7iq4v3xwwjwd1m";

		public static createInstance():UI_ScrollBarH {
			return <UI_ScrollBarH><any>(fairygui.UIPackage.createObject("BlueSkin","ScrollBarH"));
		}
