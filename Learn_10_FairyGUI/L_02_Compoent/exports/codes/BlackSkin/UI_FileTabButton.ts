...
module TestFGUI.BlackSkin {
	...
	export class UI_FileTabButton extends fairygui.GButton {
		...
		public static URL:string = "ui://7g5he7apfk7w39";

		public static createInstance():UI_FileTabButton {
			return <UI_FileTabButton><any>(fairygui.UIPackage.createObject("BlackSkin","FileTabButton"));
		}
