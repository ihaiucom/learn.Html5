...
module TestFGUI.BlackSkin {
	...
	export class UI_Checkbox extends fairygui.GButton {
		...
		public static URL:string = "ui://7g5he7apfk7w8";

		public static createInstance():UI_Checkbox {
			return <UI_Checkbox><any>(fairygui.UIPackage.createObject("BlackSkin","Checkbox"));
		}
		...
		protected constructFromXML(xml: any): void {
			...
			this.m_n7 = <fairygui.GImage><any>(this.getChildAt(4));
		}
	}
}